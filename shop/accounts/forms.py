...
class UserRegisterForm(UserCreationForm):
    username = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "placeholder": "لطفا نام کاربری مورد نظر خود را وارد کنید",
    ...
    password2 = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={
                "placeholder": "لطفا رمز را دوباره وارد کنید",
                "class": "input_second input_all",
            }
        ),
        error_messages={"required": "لطفاً این فیلد را پر کنید"},
...
class ProfileUpdateForm(forms.ModelForm):
    ...
    age = forms.IntegerField(
        widget=forms.NumberInput(attrs={"class": "input_second input_all"}),
        label="سن",
    )
    gender = forms.ChoiceField(
        choices=GENDER_CHOICES,
        widget=forms.Select(attrs={"class": "input_second input_all"}),
        label="جنسیت",
    )
    ...
    customer_image = forms.ImageField(
        widget=forms.ClearableFileInput(attrs={"class": "input_second input_all"}),
        label="تصویر مشتری",
    )
