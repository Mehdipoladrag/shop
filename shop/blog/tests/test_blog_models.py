...
class BlogModelTest(TestCase): 
    def setUp(self): 
        ...
        self.category = Category_blog.objects.create(name="BlogTestcategory", slug_cat="Test")
...
class VisitorModelTest(TestCase):
    def setUp(self): 
        ...
        self.category = Category_blog.objects.create(name="Test Category", slug_cat="test-category")
    ...
    def test_create_visitor(self):
        ...
        self.assertAlmostEqual(visitor.timestamp, timezone.now(), delta=timezone.timedelta(seconds=1))